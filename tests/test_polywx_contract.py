...
class PolyWXDashboardContractTests(unittest.TestCase):
    ...
    def test_city_workbench_exposes_single_navigation_and_tabs(self):
        ...
        self.assertIn("city.cityScope === 'observation_only'", app)
    ...
    def test_hourly_temperature_chart_matches_polywx_series_contract(self):
        ...
        self.assertIn('dataKey="cloud_pct" name="云量 %"', chart)
        ...
        self.assertIn("`peak ${peakHour}`", chart)
    ...
    def test_round5_i18n_city_status_delta_and_alpha_contract(self):
        ...
        self.assertIn("单桶显示模型差", panel)
        self.assertIn("全桶成本", panel)
        self.assertIn("最近全桶成本", panel)
        self.assertIn("盘口已过期", panel)
        self.assertIn("旧价差", panel)
    ...
    def test_scheduler_status_contract_is_visible_to_dashboard(self):
        ...
        self.assertIn('EvidenceBadge label="中国天气实况"', panel)
        ...
        self.assertIn("旧价差", read_text("frontend/src/components/ExecutionWorkbench.tsx"))
    ...
    def test_polywx_workbench_hierarchy_uses_native_evidence_once(self):
        ...
        self.assertIn("xl:grid-cols-[220px_minmax(600px,1fr)_340px]", app)
        self.assertIn("按站点浏览", app)
        ...
        self.assertIn('EvidenceBadge label="预报"', panel)
        self.assertIn('EvidenceBadge label="METAR"', panel)
        self.assertIn('EvidenceBadge label="历史观测"', panel)
        self.assertIn('EvidenceBadge label="中国天气实况"', panel)
