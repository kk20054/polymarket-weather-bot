...
- September 8 release: `0906211` (including NOAA fix `01fc976`) pushed to main and feature branch. Vercel Git deployment `5GAL9MVuTnmVSdgD4sKcpTakrLwD` completed. `polywxx.org` serves matching `index-KPi9IDvA.js` / `index-Cew7hYXz.css`; public health HTTP 200. Frontend release build passed; existing bundle-size/caniuse warnings only.
