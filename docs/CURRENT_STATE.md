...
## Production Blockers
- The new scheduler implementation still needs an uninterrupted 24-hour soak from commit `d4c90f7`; the earlier soak was invalidated because the Gamma poller refreshed only the structured audit table, not the decision orderbook table.
